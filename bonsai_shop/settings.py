"""
Django settings for bonsai_shop project.
...
if DEVELOPMENT:
    ALLOWED_HOSTS = ['localhost', '127.0.0.1', '127.0.0.1:8000', "three-oaks.herokuapp.com"]
else:
...
WSGI_APPLICATION = 'bonsai_shop.wsgi.application'
